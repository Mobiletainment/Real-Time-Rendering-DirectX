...
Render2Texture::Render2Texture(Render2Texture& other)
{
}
...
bool Render2Texture::Initialize(ID3D10Device* device, int textureWidth, int textureHeight, float screenDepth, float screenNear)
{
...
void Render2Texture::SetRenderTarget(ID3D10Device* device)
{
...
void Render2Texture::ClearRenderTarget(ID3D10Device* device, float red, float green, float blue, float alpha)
{
	float color[4];
...
ID3D10ShaderResourceView* Render2Texture::GetShaderResourceView()
{
	return m_shaderResourceView;
}

void Render2Texture::GetProjectionMatrix(D3DXMATRIX& projectionMatrix)
{
	projectionMatrix = m_projectionMatrix;
	return;
}

void Render2Texture::GetOrthoMatrix(D3DXMATRIX& orthoMatrix)
{
